...
export async function updateSession(request: NextRequest) {
  ...
  // IMPORTANT: You *must* return the supabaseResponse object as is. If you're creating a new
  ...
  // If you do not do these steps, you may potentially create a session-restore issue where the 
  // server-side session is out of sync with the client-side session.
